...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_BE_BASE_URL}/api/all_customers?userType=Customer`, {
            method: 'GET',
            headers: {
        ...
        fetch(`${process.env.REACT_APP_BE_BASE_URL}/api/all_customers?userType=Hotel_Owner`, {
            method: 'GET',
            headers: {
                'Authorization': `${localStorage.getItem('token')}`,
            },
        ...
        fetch(`${process.env.REACT_APP_BE_BASE_URL}/api/all_bookings`, {
            method: 'GET',
            headers: {
                'Authorization': `${localStorage.getItem('token')}`,
            },
